...
This project is indexed by GitNexus as **pagar-fe** (915 symbols, 2184 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
